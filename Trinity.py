...
#    os.system("aplay -q %s" % wait)
    ...
    while p_cnt <= (len(Providers_To_Use) - len(Blacklisted)):
        ...
        try:
            ...
            if len(response) < 1:
                ...
                Current_Provider_Id += 1
            ...
            elif "Request ended with status code 404" in str(response):

                 print("\n-Trinity:Error:Request ended with status code 404")
                 ...
                 os.system("aplay -q %s" % wait)
                 save_blacklist(Providers_To_Use[Current_Provider_Id],"Request ended with status code 404")
